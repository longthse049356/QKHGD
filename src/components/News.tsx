  ...
  return (
    <div className='w-[1024px] mx-auto shadow flex gap-6 p-2 rounded bg-white'>
      <div className='max-w-[512px]'>
        <iframe width="512px" height="300" src="https://www.youtube.com/embed/tTu907I0JPc?si=JCsPE65wPkKQ4VkD"
        ...
        <div className='flex mt-3 gap-3'>
          <Image className='h-[60px] w-[100px]' src={Image3} width={100} height={50} alt='slider-image' />
        ...
        <div className='flex mt-3 gap-3'>
          ...
          <p className='flex-1'>Tổng kết hoạt động Khuyến học, khuyến tài, xây dựng xã hội học tập năm 2024</p>
        </div>
        <div className='flex mt-3 gap-3'>
          <Image className='h-[60px] w-[100px]' src={Image11} width={100} height={50} alt='slider-image' />
      ...
      <div>
        ...
        >
          <p className='flex-1 text-sm'>
            Ban chấp hành Hội Đồng Gia Tộc.
          </p>
          <Image className='h-6 w-6' src={NewIcon} width={120} height={70} alt='slider-image' />
          <Image className='h-[70px] w-[120px] object-cover' src={Image3} width={120} height={70} alt='slider-image' />
        </Link>
        <Link
          href='#'
          className='mt-2 flex gap-3 items-center border-b border-dashed border-blue-900 pb-1'
        ...
        >
          <p className='flex-1 text-sm'>
            Cụ Trần Văn Cập phát biểu tại buổi lễ.
          </p>
          <Image className='h-6 w-6' src={NewIcon} width={120} height={70} alt='slider-image' />
          <Image className='h-[70px] w-[120px] object-cover' src={Image10} width={120} height={70} alt='slider-image' />
        </Link>
        <Link
          href='#'
          className='mt-2 flex gap-3 items-center border-b border-dashed border-blue-900 pb-1'
        ...
        >
          ...
          <Image className='h-6 w-6' src={NewIcon} width={120} height={70} alt='slider-image' />
          <Image className='h-[70px] w-[120px] object-cover' src={Image23} width={120} height={70} alt='slider-image' />
        </Link>
        <Link
          href='#'
          className='mt-2 flex gap-3 items-center border-b border-dashed border-blue-900 pb-1'
        ...
        >
          ...
          <Image className='h-6 w-6' src={NewIcon} width={120} height={70} alt='slider-image' />
          <Image className='h-[70px] w-[120px] object-cover' src={Image19} width={120} height={70} alt='slider-image' />
        </Link>
        <Link
          href='#'
          className='mt-2 flex gap-3 items-center border-b border-dashed border-blue-900 pb-1'
        ...
        >
          ...
          <Image className='h-6 w-6' src={NewIcon} width={120} height={70} alt='slider-image' />
          <Image className='h-[70px] w-[120px] object-cover' src={Image4} width={120} height={70} alt='slider-image' />
        </Link>
        <Link
          href='#'
          className='mt-2 flex gap-3 items-center border-b border-dashed border-blue-900 pb-1'
        ...
        >
          ...
          <Image className='h-6 w-6' src={NewIcon} width={120} height={70} alt='slider-image' />
          <Image className='h-[70px] w-[120px] object-cover' src={Image5} width={120} height={70} alt='slider-image' />
        </Link>
        <Link
          href='#'
          className='mt-2 flex gap-3 items-center border-b border-dashed border-blue-900 pb-1'
        ...
        >
          ...
          <Image className='h-6 w-6' src={NewIcon} width={120} height={70} alt='slider-image' />
          <Image className='h-[70px] w-[120px] object-cover' src={Image6} width={120} height={70} alt='slider-image' />
        </Link>
        <Link
          href='#'
        ...
        >
          ...
          <Image className='h-6 w-6' src={NewIcon} width={120} height={70} alt='slider-image' />
          <Image className='h-[70px] w-[120px] object-cover' src={Image8} width={120} height={70} alt='slider-image' />
        </Link>
      </div>
    </div>
  )
